...
public class Utf8Old extends Utf8 {
  ...
  private static final ThreadLocal<Cache> CACHE = initStaticThreadLocalCache();
      //ThreadLocal.withInitial(() -> new Cache());

  private static ThreadLocal<Cache> initStaticThreadLocalCache()
  {
    ThreadLocal<Cache> retVal = new ThreadLocal<Cache>();
    retVal.set(new Cache());
    return retVal;
  }
