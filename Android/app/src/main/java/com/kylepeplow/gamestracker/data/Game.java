...
public final class Game extends Table {
  ...
  public Platform systems(Platform obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int systemsLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public boolean finished() { int o = __offset(8); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  public boolean complete() { int o = __offset(10); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public static void addFinished(FlatBufferBuilder builder, boolean finished) { builder.addBoolean(2, finished, false); }
  public static void addComplete(FlatBufferBuilder builder, boolean complete) { builder.addBoolean(3, complete, false); }
